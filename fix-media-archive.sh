#!/bin/bash
# ═══════════════════════════════════════════════════════════════
# Fix: media-archive.tsx komplett neu (mit SearXNG-Buttons)
# ═══════════════════════════════════════════════════════════════
cd /var/www/menucard-pro

echo "=== Fix media-archive.tsx ==="

# Backup
cp src/components/admin/media-archive.tsx src/components/admin/media-archive.tsx.bak-broken 2>/dev/null || true
...
echo "  \u2713 media-archive.tsx neu geschrieben"
