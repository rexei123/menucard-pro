#!/bin/bash
# Fix: Editierbare Zellen verlieren Fokus nach jedem Tastendruck
# Problem: EditableCell war innerhalb der Render-Funktion definiert
# Datum: 10.04.2026
