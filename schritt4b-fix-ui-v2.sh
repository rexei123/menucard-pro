...
echo "Fix v2: Werkstatt komplett neu mit Badges oberhalb + Label-Fix"

cp src/app/admin/design/page.tsx src/app/admin/design/page.tsx.bak-4b-v2
...
echo "  OK: Werkstatt neu (Badges oberhalb der Vorschau)"
echo ""
echo "Build..."
