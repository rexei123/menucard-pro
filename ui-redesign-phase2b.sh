...
set -e
echo "============================================"
echo "  UI-Redesign Phase 2b: Dashboard"
echo "============================================"

cd /var/www/menucard-pro

# Backup
cp src/app/admin/page.tsx src/app/admin/page.tsx.bak-redesign

# ============================================
# NEUES DASHBOARD
# ============================================
echo "[1/1] Dashboard neu schreiben..."

cat > src/app/admin/page.tsx << 'DASHEOF'
...
echo ""
echo "============================================"
echo "  UI-Redesign Phase 2b: Dashboard FERTIG!"
echo "============================================"
echo "  - 4 KPI-Kacheln (Produkte, Karten, QR, Bilder)"
echo "  - Letzte Änderungen mit Thumbnails"
echo "  - Live-Design Status Karte"
echo "  - Schnellzugriff (Menü + Design + Bildarchiv)"
echo "  - Datenübersicht (Gruppen, Übersetzungen, Sprachen)"
echo "============================================"
