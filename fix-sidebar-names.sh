...
set -e
echo "============================================"
echo "  Fix: Sidebar-Namen + Gruppierung"
echo "============================================"

cd /var/www/menucard-pro

cp src/components/admin/icon-bar.tsx src/components/admin/icon-bar.tsx.bak
...
echo ""
echo "============================================"
echo "  Fix Sidebar-Namen + Gruppierung: FERTIG!"
echo "============================================"
echo "  Änderungen:"
echo "  - Gruppierung: Inhalt / Tools / Einstellungen"
echo "  - Menüverwaltung → Produkte"
echo "  - Templates → Karten-Design"
echo "  - Bildarchiv unter Inhalt"
echo "  - Benutzer wieder als eigener Punkt"
echo "  - Aktualisieren → neu laden"
echo "============================================"
