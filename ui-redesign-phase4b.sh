...
set -e
echo "============================================"
echo "  UI-Redesign Phase 4b: Einstellungen"
echo "============================================"
...
cp src/app/admin/settings/page.tsx src/app/admin/settings/page.tsx.bak 2>/dev/null || true

# ============================================
# 1. EINSTELLUNGEN-SEITE
# ============================================
echo "[1/1] Einstellungen-Seite erstellen..."

cat > src/app/admin/settings/page.tsx << 'SETEOF'
'use client';
...
echo ""
echo "============================================"
echo "  UI-Redesign Phase 4b: Einstellungen FERTIG!"
echo "============================================"
echo "  - 4-Tab Sub-Navigation"
echo "  - Allgemein: Hotel-Info, Anzeige-Optionen mit Toggles"
echo "  - Sprache & Region: Sprache, Währung, Auto-Übersetzung"
echo "  - Konto: E-Mail, Rolle, Passwort ändern"
echo "  - Über: System-Info, Status-Anzeige"
