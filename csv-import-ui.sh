#!/bin/bash
# MenuCard Pro – CSV-Import: Admin-UI
# Datum: 10.04.2026
...
echo "[1/3] CSV-Import-Komponente erstellt"

# === 2. Admin-Seite aktualisieren ===
...
echo "[2/3] Admin-Seite aktualisiert"

# === 3. Prüfen ob Import in der Icon-Bar verlinkt ist ===
if grep -q 'import' src/components/admin/icon-bar.tsx; then
  echo "[3/3] Import ist bereits in der Navigation"
else
  echo "[3/3] HINWEIS: Import-Link ggf. manuell zur Icon-Bar hinzufügen"
fi
...
echo "=== Fertig! ==="
echo ""
echo "CSV-Import ist jetzt verfügbar unter: http://178.104.138.177/admin/import"
echo "CSV-Vorlage: http://178.104.138.177/templates/import-vorlage.csv"
echo ""
echo "Unterstützte Spalten (DE oder EN):"
echo "  Basis: sku, type/typ, name_de/name, name_en, short_description_de/kurzbeschreibung"
echo "  Preis: fill_quantity/fuellmenge, price_level/preisebene, price/preis, purchase_price/ek"
echo "  Wein:  winery/weingut, vintage/jahrgang, grapes/rebsorten, region, country/land, wine_style"
echo "  Getränk: brand/marke, producer/produzent, bev_category/getraenkekategorie, bev_alcohol"
