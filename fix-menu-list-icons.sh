...
set -e
echo "============================================"
echo "  Fix: Kartenliste Icons + Legacy-Amber"
echo "============================================"

cd /var/www/menucard-pro

cp src/components/admin/menu-list-panel.tsx src/components/admin/menu-list-panel.tsx.bak-icons

cat > src/components/admin/menu-list-panel.tsx << 'EOF'
'use client';
...
echo "  menu-list-panel.tsx neu geschrieben"
...
echo ""
echo "============================================"
echo "  Kartenliste-Icons: FERTIG"
echo "============================================"
echo "  - Icons: Material Symbols korrekt gerendert"
echo "  - Active-State: amber -> rosa (UI-Primary)"
