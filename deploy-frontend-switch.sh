...
echo "=== Switching Frontend to Product/MenuPlacement ==="

echo "1/3 Backing up..."
cp "src/app/(public)/[tenant]/[location]/[menu]/page.tsx" /tmp/menu-page.bak
cp "src/app/(public)/[tenant]/[location]/[menu]/item/[itemId]/page.tsx" /tmp/item-detail.bak

echo "2/3 Writing files..."

# === FILE 1: Menu Page (reads from placements → product) ===
...
# === FILE 2: Item Detail Page (reads from Product) ===
...
echo ""
echo "=== Frontend switched to Product/MenuPlacement! ==="
echo "Test:"
echo "  http://178.104.138.177/hotel-sonnblick/restaurant/weinkarte"
echo "  http://178.104.138.177/hotel-sonnblick/bar/barkarte"
