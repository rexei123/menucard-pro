  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      <div className="relative w-full max-w-md bg-white h-full overflow-y-auto shadow-2xl flex flex-col">
        <div className="sticky top-0 bg-white border-b border-gray-100 px-6 py-4 flex items-center justify-between z-10 overflow-x-auto whitespace-nowrap">
          <div>
        ...
        <div className="sticky bottom-0 bg-white border-t border-gray-100 px-6 py-4 flex gap-2 overflow-x-auto whitespace-nowrap">
