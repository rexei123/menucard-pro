...
set -e
echo "============================================"
echo "  UI-Redesign Phase 3b: Minimal Template"
echo "============================================"
...
# 1. MINIMAL RENDERER
# ============================================
echo "[1/2] Minimal-Renderer erstellen..."
mkdir -p src/components/templates

cat > src/components/templates/minimal-renderer.tsx << 'MINEOF'
'use client';
...
# ============================================
# 2. MENU-CONTENT.TSX – Minimal einbinden
# ============================================
echo "[2/2] menu-content.tsx: Minimal-Template einbinden..."

# Import hinzufügen (nach dem letzten Import)
sed -i "s/import Link from 'next\/link';/import Link from 'next\/link';\nimport { MinimalSection } from '.\/templates\/minimal-renderer';/" src/components/menu-content.tsx

# Template-Switch aktualisieren
sed -i "s/: template === 'minimal' ? renderElegantSection  \/\* TODO: eigenes Template \*\//: template === 'minimal' ? renderMinimalSection/" src/components/menu-content.tsx

# Minimal-Render-Funktion vor dem Template-Switch einfügen
# Wir nutzen Python für den gezielten Einfüge-Punkt
cat > /tmp/add-minimal.py << 'PYEOF'
...
# Einfügen vor "const renderSection = template ==="
marker = "  /* ====================================================\n   * RENDER: Choose template renderer"
content = content.replace(marker, minimal_fn + "  /* ====================================================\n   * RENDER: Choose template renderer")

with open('src/components/menu-content.tsx', 'w') as f:
    f.write(content)
print("Minimal template integrated")
PYEOF
python3 /tmp/add-minimal.py
rm -f /tmp/add-minimal.py
...
echo ""
echo "============================================"
echo "  UI-Redesign Phase 3b: Minimal Template FERTIG!"
echo "============================================"
echo "  - MinimalSection + MinimalItem Komponenten"
echo "  - Bold Montserrat-Typografie, keine Bilder"
echo "  - Uppercase Sektions-Header mit Count-Badge"
echo "  - Allergen-Codes inline, Tags als Uppercase"
echo "  - Template-Switch in menu-content.tsx"
echo "============================================"
