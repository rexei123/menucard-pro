...
/**
 * CLASSIC Template – Design Strategie 2.0
 * Headlines: Playfair Display  |  Body: Lato / Inter-Default
 * Geaendert aus der Vorversion (Cormorant Garamond), da Compliance-Spec
 * Playfair Display fuer Classic vorschreibt (Symmetrie mit Elegant:
 * beide nutzen Playfair fuer Ueberschriften, unterscheiden sich im Body).
 */
export const classicTemplate: DesignConfig = {
  digital: {
    ...
    density: 'normal',
    typography: {
      h1: { font: 'Playfair Display', size: 36, weight: 700, color: '#2C2C2C', transform: 'none', spacing: 0 },
      h2: { font: 'Playfair Display', size: 24, weight: 600, color: '#6B4C1E', transform: 'none', spacing: 0.02 },
  ...
  analog: {
    ...
    titlePage: { logo: null, logoBgColor: '#6B4C1E', logoBgImage: null, logoPosition: 'center', logoSize: 160, quote: null, quoteEN: null, quoteAuthor: null, quoteFont: 'Playfair Display', freeBlocks: [] },
    toc: { depth: 'category', lineStyle: 'dotted', bilingual: true, indented: false, position: 'afterTitle' },
    typography: {
      sectionTitle: { font: 'Playfair Display', size: 32, color: '#2C2C2C' },
      subCategory: { font: 'Lato', size: 13, weight: 700, color: '#555555' },
      subGrouping: { font: 'Playfair Display', size: 16, color: '#333333' },
    ...
    headerFooter: {
      header: { repeatSectionName: false, font: 'Playfair Display', dividerLine: true },
