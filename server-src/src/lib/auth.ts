...
declare module 'next-auth' {
  interface User { id: string; email: string; firstName: string | null; lastName: string | null; role: string; tenantId: string; tenantSlug: string; }
  interface Session { user: User; }
}
declare module 'next-auth/jwt' {
  interface JWT { id: string; role: string; tenantId: string; tenantSlug: string; firstName: string | null; lastName: string | null; }
}
