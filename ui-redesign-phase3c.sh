...
set -e
echo "============================================"
echo "  UI-Redesign Phase 3c: Modern Template"
echo "============================================"
...
# 1. MODERN RENDERER
# ============================================
echo "[1/2] Modern-Renderer erstellen..."
mkdir -p src/components/templates

cat > src/components/templates/modern-renderer.tsx << 'MODEOF'
'use client';
            ...
            <div
              ...
              style={{
                backgroundColor: item.highlightType === 'NEW' ? '#DD3C71'
                  : item.highlightType === 'POPULAR' ? '#F59E0B'
                  : 'rgba(255,255,255,0.9)',
                color: ['NEW', 'POPULAR', 'PREMIUM'].includes(item.highlightType || '') ? '#FFF' : '#171A1F',
              }}
            >
...
# ============================================
# 2. MENU-CONTENT.TSX – Modern einbinden
# ============================================
echo "[2/2] menu-content.tsx: Modern-Template einbinden..."

# Import hinzufügen
sed -i "s/import { MinimalSection } from '.\/templates\/minimal-renderer';/import { MinimalSection } from '.\/templates\/minimal-renderer';\nimport { ModernSection } from '.\/templates\/modern-renderer';/" src/components/menu-content.tsx

# Modern-Render-Funktion einfügen (vor dem Choose-Kommentar)
cat > /tmp/add-modern.py << 'PYEOF'
...
content = content.replace(marker, modern_fn + "  /* ====================================================\n   * RENDER: Choose template renderer")
...
with open('src/components/menu-content.tsx', 'w') as f:
    f.write(content)
print("Modern template integrated")
PYEOF
python3 /tmp/add-modern.py
rm -f /tmp/add-modern.py
...
echo ""
echo "============================================"
echo "  UI-Redesign Phase 3c: Modern Template FERTIG!"
echo "============================================"
echo "  - ModernSection + ModernItem Komponenten"
echo "  - Card-Layout mit großen Bildern"
echo "  - Highlight-Badges (Neu rosa, Beliebt gelb)"
echo "  - Preis in Rosa (#DD3C71)"
echo "  - 2-Spalten Grid auf größeren Screens"
echo "  - Details-Link mit Chevron"
echo "============================================"
