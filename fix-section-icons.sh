...
set -e
echo "============================================"
echo "  Fix: Section-Icons (Emoji -> Material)"
echo "  + Drop-Indicator/Resize auf UI-Design"
echo "============================================"

cd /var/www/menucard-pro

# Backups
cp src/components/admin/menu-editor.tsx src/components/admin/menu-editor.tsx.bak-sectionicons

# ============================================
# 1. DB-Migration: Emojis -> Material Symbols
# ============================================
echo "[1/3] DB-Migration..."

psql "postgresql://menucard:ccTFFSJtuN7l1dC17PzT8Q@127.0.0.1:5432/menucard_pro" << 'SQL'
-- Backup aktuelle Icons
CREATE TABLE IF NOT EXISTS "_MenuSection_icon_backup" AS
SELECT id, icon, now() as backed_up_at FROM "MenuSection";

-- Mapping
UPDATE "MenuSection" SET icon = 'coffee'                WHERE icon = '☕';
UPDATE "MenuSection" SET icon = 'local_florist'         WHERE icon = '🌸';
UPDATE "MenuSection" SET icon = 'eco'                   WHERE icon = '🌿';
UPDATE "MenuSection" SET icon = 'emoji_food_beverage'   WHERE icon = '🍋';
UPDATE "MenuSection" SET icon = 'cake'                  WHERE icon = '🍫';
UPDATE "MenuSection" SET icon = 'cake'                  WHERE icon = '🍰';
UPDATE "MenuSection" SET icon = 'emoji_food_beverage'   WHERE icon = '🍵';
UPDATE "MenuSection" SET icon = 'wine_bar'              WHERE icon = '🍷';
UPDATE "MenuSection" SET icon = 'local_bar'             WHERE icon = '🍸';
UPDATE "MenuSection" SET icon = 'nightlife'             WHERE icon = '🍹';
UPDATE "MenuSection" SET icon = 'sports_bar'            WHERE icon = '🍺';
UPDATE "MenuSection" SET icon = 'restaurant'            WHERE icon = '🍽️';
UPDATE "MenuSection" SET icon = 'flag'                  WHERE icon = '🏴‍☠️';
UPDATE "MenuSection" SET icon = 'local_fire_department' WHERE icon = '🔥';
UPDATE "MenuSection" SET icon = 'celebration'           WHERE icon = '🥂';
UPDATE "MenuSection" SET icon = 'liquor'                WHERE icon = '🥃';
UPDATE "MenuSection" SET icon = 'eco'                   WHERE icon = '🥗';
UPDATE "MenuSection" SET icon = 'local_drink'           WHERE icon = '🥤';
UPDATE "MenuSection" SET icon = 'dining'                WHERE icon = '🧀';
UPDATE "MenuSection" SET icon = 'local_florist'         WHERE icon = '🫐';
UPDATE "MenuSection" SET icon = 'spa'                   WHERE icon = '🫒';

-- Kontrolle
SELECT icon, COUNT(*) FROM "MenuSection" GROUP BY icon ORDER BY icon;
SQL

echo "  DB-Migration abgeschlossen"

# ============================================
# 2. menu-editor.tsx neu schreiben
# ============================================
echo "[2/3] menu-editor.tsx neu schreiben..."

cat > src/components/admin/menu-editor.tsx << 'EOF'
'use client';
...
echo "  menu-editor.tsx neu geschrieben"
...
echo ""
echo "============================================"
echo "  Section-Icons + UI-Design: FERTIG"
echo "============================================"
echo "  - DB: 21 Emojis -> Material-Symbol-Namen"
echo "  - Section-Header: Icons korrekt gerendert"
echo "  - Drop-Indicator: blau -> rosa"
echo "  - Resize-Handle: amber -> rosa"
echo "  - Produkt-Link Hover: amber -> rosa"
echo "  - + Button Pool: gruen #22C55E"
echo "============================================"
