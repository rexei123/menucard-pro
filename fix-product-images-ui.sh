...
set -e
echo "============================================"
echo "  Fix UI: product-images.tsx"
echo "  5 Design-Verstoesse im Bilder-Bereich"
echo "============================================"

cd /var/www/menucard-pro

# Backup
cp src/components/admin/product-images.tsx src/components/admin/product-images.tsx.bak-ui

# Datei komplett neu schreiben
cat > src/components/admin/product-images.tsx << 'EOF'
'use client';
...
echo ""
echo "============================================"
echo "  product-images.tsx: UI-Design konform"
echo "============================================"
echo "  - Aus Bildarchiv: gold -> rosa outline"
echo "  - + Hochladen: gold -> gruen #22C55E"
echo "  - Hauptbild Badge: amber -> rosa primary"
echo "  - Bild-Ring aktiv: amber -> rosa primary"
echo "  - Hover Hauptbild-Button: amber -> rosa"
echo "  - Drop-Zone Drag: blau -> rosa"
echo "============================================"
