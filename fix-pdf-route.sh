#!/bin/bash
# MenuCard Pro – PDF-Route auf neues Product/MenuPlacement-Modell umbauen
# Datum: 10.04.2026
...
# Backup
cp src/app/api/v1/pdf/route.tsx src/app/api/v1/pdf/route.tsx.bak
echo "[1/3] Backup erstellt"

# Neue Route schreiben
cat > src/app/api/v1/pdf/route.tsx << 'ENDOFFILE'
...
echo "[2/3] Neue PDF-Route geschrieben"
...
echo ""
echo "[3/3] Fertig! PDF-Route erfolgreich aktualisiert."
