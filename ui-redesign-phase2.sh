...
set -e
echo "============================================"
echo "  UI-Redesign Phase 2: Admin-Sidebar"
echo "============================================"

cd /var/www/menucard-pro

# Backups
cp src/components/admin/icon-bar.tsx src/components/admin/icon-bar.tsx.bak-redesign
cp src/app/admin/layout.tsx src/app/admin/layout.tsx.bak-redesign

# ============================================
# 1. NEUE SIDEBAR (ersetzt icon-bar.tsx)
# ============================================
echo "[1/2] Neue Sidebar erstellen..."

cat > src/components/admin/icon-bar.tsx << 'SIDEBAREOF'
'use client';
...
# ============================================
# 2. ADMIN-LAYOUT (neuer Hintergrund)
# ============================================
echo "[2/2] Admin-Layout anpassen..."

cat > src/app/admin/layout.tsx << 'LAYOUTEOF'
...
echo ""
echo "============================================"
echo "  UI-Redesign Phase 2: FERTIG!"
echo "============================================"
echo "  - Neue Sidebar mit Material Symbols Icons"
echo "  - Rosa Akzent (#DD3C71) für aktiven Menüpunkt"
echo "  - User-Info mit Avatar unten"
echo "  - Collapsible (ein-/ausklappbar)"
echo "  - Admin-Hintergrund: subtle grey"
echo "============================================"
