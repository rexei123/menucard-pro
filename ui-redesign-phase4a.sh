...
set -e
echo "============================================"
echo "  UI-Redesign Phase 4a: Template-Auswahl"
echo "============================================"

cd /var/www/menucard-pro

# Backup
cp src/app/admin/design/page.tsx src/app/admin/design/page.tsx.bak 2>/dev/null || true

# ============================================
# 1. TEMPLATE-AUSWAHL SEITE
# ============================================
echo "[1/1] Template-Auswahl Seite erstellen..."

cat > src/app/admin/design/page.tsx << 'TPLEOF'
'use client';
...
echo ""
echo "============================================"
echo "  UI-Redesign Phase 4a: Template-Auswahl FERTIG!"
echo "============================================"
echo "  - 4 Template-Cards (Elegant, Modern, Klassisch, Minimal)"
echo "  - Aktiv-Badge zeigt zugewiesene Karten"
echo "  - Expandierbare Kartendetails"
echo "  - Template-Vergleichstabelle"
echo "  - Quick-Action: 'Zu den Karten' Link"
echo "  - Token-basiertes Styling (#DD3C71 Akzent)"
echo "  - Playfair Display + Inter Fonts"
echo "  - Material Symbols Icons"
echo "============================================"
